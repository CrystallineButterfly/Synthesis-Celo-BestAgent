...
- `celo_payment_settle` — Celo — Use Celo for a bounded action in this repo.
...
- Deploy the contract with forge script script/Deploy.s.sol --broadcast for CeloPaymentController.
- Run python3 scripts/run_agent.py to produce a dry run for celo_operator.
