...
- Slice
        ...
        ```mermaid
        flowchart TD
    Signals[Celo Best Agent on Celo signals] --> Discover[Discover]
    Discover --> Plan[Plan bounded action]
    Plan --> DryRun[Dry run + policy check]
    DryRun --> Guard[CeloPaymentController]
...
5. Verify receipts, proofs, and notes, then append structured logs.
        ...
        This concept ranks highest because it overlaps PayWithLocus, Octant, ERC-8004 Receipts while keeping the
